...
import AddNewProductDrawer from '@/views/memory-plantation/product/list/AddNewProductDrawer.vue'
...
// 👉 Fetching users
const { data: usersData, execute: fetchProducts } = await useApi<any>(createUrl('/apps/users', {
  query: {
    q: searchQuery,
...
const addNewProduct = async (productData: object) => {
  await $api('product', {
    method: 'POST',
    body: productData,
  })
