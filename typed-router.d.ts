...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'memory-plantation-order': RouteRecordInfo<'memory-plantation-order', '/memory-plantation/order', Record<never, never>, Record<never, never>>,
    'memory-plantation-product': RouteRecordInfo<'memory-plantation-product', '/memory-plantation/product', Record<never, never>, Record<never, never>>,
